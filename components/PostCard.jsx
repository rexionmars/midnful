            ...
            <div className='relative overflow-hidden pb-80 mb-6'>
                <img
                   src={post.featuredImage.url}
                    alt={post.title}
                    className='object-top absolute h-80 w-full object-cover bg-center  rounded-t-xl'
                />
            </div>
            <h1 className="font-varela text-center mb-8 cursor-pointer text-zinc-300 lg:text-4xl text-2xl font-semibold subpixel-antialiased">
                <Link href={`/post/${post.slug}`}>{post.title}</Link>
            </h1>
            <div className='block lg:flex text-center items-center justify-center lg:mb-8 mb-0 w-full'>
                ...
                <div className='lg:visible invisible font-light text-pink-500 bg-pink-300 px-2 rounded-lg'>
