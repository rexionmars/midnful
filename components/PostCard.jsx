...
const PostCard = ({ post }) => {
    // console.log(post)
    return (
        <div className='border-2 border-zinc-200 bg-gray-100 shadow-xl rounded-xl p-0 lg:pb-5 pb-12 mb-8'>
            ...
            <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
                <div className='flex items-center justify-center mb-4 lg:mb-0 w-full  lg:w-auto mr-8'>
                    ...
                    />
                    <p className='inline align-middle font-medium text-gray-700 ml-3 text-lg'>{post.author.name}</p>
                </div>
                <div className='font-medium text-orange-600 bg-orange-300 p-1 px-2 rounded-lg'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline mr-2 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
