            ...
            <div className="team-card">
                ...
                <div className="card">
                    ...
                    <div className="content">
                        <h3 className="mt-5 mb-5">Leonardi</h3>
                        <label className="bg-purple-400 text-purple-700 p-1 px-2 border rounded-xl border-none">Developer and Maintainer</label>
                ...
                <div className="card ">
                    ...
                    <div className="content">
                        <h3 className="mt-5 mb-5">Antônio Neves</h3>
                ...
                <div className="card">
                    ...
                    <div className="content">
                        <h3 className="mt-5 mb-5">Beatriz Barreto</h3>
                ...
                <div className="card">
                    ...
                    <div className="content">
                        <h3 className="mt-5 mb-5">Cristovam</h3>
                ...
                <div className="card">
                    ...
                    <div className="content">
                        <h3 className="mt-5 mb-5">Wickham</h3>
                ...
                <div className="card">
                    ...
                    <div className="content">
                        <h3 className="mt-5 mb-5">Guilherme</h3>
