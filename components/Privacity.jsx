        ...
        <div className="justify-center trs flex flex-row w-full align-middle mb-10">
            <div className="align-middle lg:w-[70%] w-[80%]">
                ...
                <div className="text-gray-200 text-base">
                    ...
                    1.1 O site tem como objetivo fornecer acesso a artigos escritos por psicólogos profissionais, contendo informações e dicas confiáveis sobre saúde mental, bem-estar e assuntos relacionados.<br /><br />
                    ...
                    <p className="text-left ml-10 my-5">
                    2.1 Reconhecemos a importância da privacidade e estamos comprometidos em proteger seus dados pessoais. Todo o processamento de dados é realizado em conformidade com a Lei Geral de Proteção de Dados (LGPD) e demais legislações aplicáveis.<br /><br />
                    ...
                    3.3 Os criadores do site não se responsabilizam por qualquer ação, conduta ou dano causado pelos psicólogos divulgados no projeto. É responsabilidade exclusiva do usuário verificar a credibilidade, qualificações e licenças dos profissionais de saúde mental antes de utilizar seus serviços.<br /><br />
