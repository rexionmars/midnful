        ...
        <div className="justify-center flex flex-row w-full align-middle mb-10">
            <div className="align-middle w-[80%]">
                ...
                <p className="text-gray-200 text-base">
                    Bem-vindo(a) ao Mindful Explorer, nosso site de artigos e dicas de saúde mental! Antes de prosseguir, é importante que você leia e compreenda os termos e condições de uso descritos abaixo. Ao acessar e utilizar nosso site, você concorda em cumprir e estar sujeito a estes termos. Se você não concorda com algum aspecto deste documento, recomendamos que você não utilize nossos serviços.<br />
                    1.Uso e Propósito do Site<br />
                    1.1 O site tem como objetivo fornecer acesso a artigos escritos por psicólogos profissionais, contendo informações e dicas confiáveis sobre saúde mental, bem-estar e assuntos relacionados.<br />
                    1.2 Os artigos disponíveis no site são fornecidos apenas para fins informativos e não substituem a consulta a um profissional de saúde mental. Eles não devem ser interpretados como aconselhamento médico ou psicológico, nem devem ser utilizados para realizar autodiagnósticos. Os criadores do site não se responsabilizam por quaisquer consequências decorrentes de autodiagnósticos feitos pelos usuários com base nos artigos publicados.<br />
                    2.Proteção de Dados e LGPD<br />
                    2.1 Reconhecemos a importância da privacidade e estamos comprometidos em proteger seus dados pessoais. Todo o processamento de dados é realizado em conformidade com a Lei Geral de Proteção de Dados (LGPD) e demais legislações aplicáveis.<br />
                    ...
                    3.1 Os criadores do site não se responsabilizam por quaisquer consequências decorrentes do uso inadequado das redes sociais dos psicólogos divulgadas no projeto.<br />
                    3.2 As redes sociais dos psicólogos divulgadas no site são de responsabilidade exclusiva dos respectivos profissionais. Os criadores do site não têm controle sobre o conteúdo publicado nessas redes sociais e não se responsabilizam por sua precisão, atualização, legalidade ou qualidade.<br />
                    3.3 Os criadores do site não se responsabilizam por qualquer ação, conduta ou dano causado pelos psicólogos divulgados no projeto. É responsabilidade exclusiva do usuário verificar a credibilidade, qualificações e licenças dos profissionais de saúde mental antes de utilizar seus serviços.<br />
                    3.4 Os criadores do site não se responsabilizam por quaisquer consequências decorrentes do uso inadequado, comentários maldosos, ataques ou interações negativas por parte dos leitores ou usuários do site nas redes sociais dos psicólogos divulgadas no projeto.<br />
                    4.Autorização de Uso de Dados<br />
                    4.1 Os criadores do site estão autorizados a utilizar os dados fornecidos pelos psicólogos profissionais, com a devida autorização dos mesmos, apenas para fins de divulgação do artigo e do trabalho do psicólogo.<br />
                    ...
                    5.1 Os termos de uso podem ser atualizados periodicamente, e tais atualizações entrarão em vigor imediatamente após sua publicação no site.<br />
                    5.2 É responsabilidade do usuário revisar regularmente os termos de uso para estar ciente de quaisquer alterações.<br />
                    Ao utilizar nosso site, você concorda com estes termos de uso e se compromete a respeitar todas as disposições aqui mencionadas. Se você tiver alguma dúvida ou preocupação, entre em contato conosco através dos canais fornecidos no site.
